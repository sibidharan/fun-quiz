---
name: zealphp
description: ZealPHP framework documentation - a lightweight PHP web framework built on OpenSwoole. Use when working with ZealPHP routing, App class, G class, superglobals mode, coroutines, templates, sessions, middleware, or API handlers.
---
